...
Localização: ???
Status: Ativa
MyContainer: "[[Loreholder's/Campanhas/Curse Of Strahd/Barovia │ Era de Ouro/Localidades/Cidades/Vallaki/Vallaki.md|Vallaki]]"
---
...
>> ![[simbolo_Casa_van_der_Voort.png|400]]
>
...
>>> > [!div-m|no-title]
>>> > ```datacards
>>> > TABLE img, status FROM #casa_van_der_voort
>>> > SORT file.name asc
>>> > 
>>> > // Settings 
>>> > preset: compact 
